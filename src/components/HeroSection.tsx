        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in space-y-8">
            <div className="space-y-6">
              <div className="inline-flex items-center px-4 py-2 bg-blue-100 text-blue-600 text-sm font-medium rounded-full animate-bounce">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 text-lg font-semibold group transform transition-all duration-300 hover:scale-105"
                size="lg"
              >
                Let's Talk
          ...
          <div className="relative animate-fade-in">
            {/* Interactive 3D-like illustration */}
            <div className="relative w-full h-96 lg:h-[500px]">
              ...
              <div 
                className="absolute inset-4 bg-white rounded-3xl shadow-2xl flex items-center justify-center transform -rotate-2"
                style={{
