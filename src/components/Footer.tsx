        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div className="text-2xl font-bold text-white">DEVIGO</div>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors p-2">
                <Facebook size={20} />
              </a>
              <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors p-2">
                <Twitter size={20} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#home" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center">
              ...
              <li>
                <a href="#services" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center">
                  <span className="text-blue-400 mr-2">→</span>
                  Services
                </a>
              </li>
              <li>
                <a href="#work" className="text-gray-400 hover:text-blue-400 transition-colors flex items-center">
                  <span className="text-blue-400 mr-2">→</span>
                  Portfolio
                </a>
              </li>
